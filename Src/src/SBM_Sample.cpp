...
//int main_SBM( int argc, char** argv )
//int main_SBM( Mat imgLeft, Mat imgRight )//,Mat &outM)
int main_SBM( Mat imgLeft, Mat imgRight ,Mat &outM)
{
  //if( argc != 3 )
  //{ readme(); return -1; }
 ...
 /* imshow("input left", imgLeft);
  imshow("input right", imgRight);*/
 ...
 /* imshow( "windowDisparity raw", imgDisparity16S );*/
